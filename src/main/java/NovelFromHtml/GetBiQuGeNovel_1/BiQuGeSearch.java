...
import NovelFromHtml.GetBiQuGeNovel_1.utils.ThreadGetAllSection;
...
public class BiQuGeSearch implements IGetNovelBySearch {
    ...
    public NovelInformation getNovelAddress(String SearchAddress) throws IOException{
        ...
        if(url.toString().matches("https://www.52bqg.com/book_.*")){
    ...
    public String parseHtmlEncoding(String novelName){
        ...
        try {
            return URLEncoder.encode(new String(novelName.getBytes(StandardCharsets.UTF_8)), "gbk");
    ...
    public boolean domain(String NovelName){
        try {
            ...
            if(info!=null){
                ...
                ThreadGetAllSection getAllSection = new ThreadGetAllSection(info);
                Class<AThreadGetTextList> threadGetTextListClass = (Class<AThreadGetTextList>) Class.forName("NovelFromHtml.GetBiQuGeNovel_1.utils.ThreadGetTextList");
    ...
    public String getSearchAddress(String novel_name) {
        ...
        //获得查询地址
        String searchAddress = "https://www.52bqg.com/modules/article/search.php?searchkey=" + novelName;
